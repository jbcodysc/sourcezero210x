...
export const isArgusLine=line=>line?.presentation==='argus'||line?.speaker==='A.R.G.U.S.';
export function argusTextMarkup(text){
...
export function argusPanelMarkup(line){
 ...
 return '<section class="dialog-box dialog-argus" aria-label="A.R.G.U.S. transmission">'+
