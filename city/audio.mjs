...
const EFFECT_FILES={'missile-launch':'scrap-missile-launch','missile-explosion':'scrap-missile-explosion','wall-breach':'scrap-wall-breach','tidal-wave':'tidal-wave-rush',vibrosword:'vibrosword-electric',bash:'bash-heavy',fanfare:'music-remastered/fanfare.ogg',victory:'music-remastered/victory.ogg','security-alarm':'argus-security-alarm','argus-boosters':'argus-blue-boosters','argus-stabilize':'argus-stabilize'};
...
export class CityAudio {
 ...
 effect(key){
  if(['missile-launch','missile-explosion','wall-breach'].includes(key)&&!['argus-battle','argus-entrance'].includes(this.mode))return;
