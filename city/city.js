...
import {beginRound,nextTurn,canRun,battleEscapeChance,carryBattleInventory,escapeProgress} from './battle-turns.mjs';
...
class BattleScene extends SceneBase{
 ...
 create(){
  state.scene=this;this.closed=false;this.rewarded=false;this.notice=null;this.goodsOpen=false;this.actionPresentation=null;this.battle=createEncounter(state.encounter.id,progress,state.encounter.ids);const b=this.battle;resetControls();$('#scene-status').hidden=true;$('#prompt').hidden=true;$('#overlay').innerHTML='';
