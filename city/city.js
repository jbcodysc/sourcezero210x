...
class ExploreScene extends SceneBase{
 ...
 create(){
  ...
  this.player=actor(this,p.x,p.y,0,110,true);this.beginRecovery();
 ...
 update(time,delta){
  advanceText(this,delta);if(!this.player)return;this.updateOcclusion();
 ...
 closeMenu(){this.menu=null;this.locked=false;$('#overlay').innerHTML='';$('#overlay').className='';resetControls();this.input.keyboard.resetKeys();}
 handleAction(action){
