import {freshProgress,STORY_XP,xpThreshold} from './progress.mjs';
...
export const CHAPTERS=Object.freeze([
 ...
 {id:2,title:'Fairmont Junction',description:'Arrive by bus. Level 10, Chapter 1 equipment, 650 credits and two sandwiches.'}
]);
...
export function createChapterProgress(chapter,name='Alex'){
 ...
 Object.assign(s,{opening:'complete',level:10,xp:xpThreshold(10),hp:218,maxHp:218,credits:650,snacks:2,upgrade:1,armor:'insulated-vest',inventory:['insulated-vest'],location:'fairmont',position:{...ARRIVAL},visited:['lab','city','water','fairmont']});
